...
film.delete('/deleteMovie/:id', middleware.verifyUserToken, filmController.deleFilm);
film.post('/createMovie', middleware.verifyUserToken, middleware.upLoadImage.fields([{ name: "images", maxCount: 10 }, { name: "poster" }]), filmController.createMovie);
